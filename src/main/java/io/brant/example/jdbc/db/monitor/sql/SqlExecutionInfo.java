package io.brant.example.jdbc.db.monitor.sql;

import io.brant.example.jdbc.db.aop.StatementType;
...
public class SqlExecutionInfo implements Serializable {
	...
	private HibernateQueryNormalizer hibernateQueryNormalizer = new HibernateQueryNormalizer();
	...
	public String getFormattedSql(boolean hibernateQueryFormatting) {
		if (hibernateQueryFormatting) {
			return hibernateQueryNormalizer.format(sqlFormatter.format(this.sql));
		}
